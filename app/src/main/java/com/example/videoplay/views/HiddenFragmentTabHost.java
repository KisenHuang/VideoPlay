...
/**
 * 切换隐藏Fragment，解决Fragment重新加载UI的问题
 *  修改原Fragment的onAttachedToWindow()方法中的 ft.detach(tab.fragment)为ft.hide(tab.fragment)
 *  解决问题
 */
public class HiddenFragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    public HiddenFragmentTabHost(Context context) {
    ...
    public HiddenFragmentTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
