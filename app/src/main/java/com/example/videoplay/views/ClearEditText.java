 ...
 *@Version:1.1.0
 */
public class ClearEditText extends AppCompatEditText implements OnFocusChangeListener, TextWatcher, OnTouchListener {
	...
	public ClearEditText(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		final Drawable drawable = ContextCompat.getDrawable(context, R.drawable.graydelete);
