package com.example.videoplay.views.swipebacklayout;
...
public class SwipeBackActivityHelper {
    ...
    public void convertActivityFromTranslucent() {
        try {
            Method method = Activity.class.getDeclaredMethod("convertFromTranslucent", Object.class);
            method.setAccessible(true);
            method.invoke(mActivity, Object.class);
        } catch (Throwable t) {
        }
    }
